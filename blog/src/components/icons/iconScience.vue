...
defineComponent({
  name: 'StreamlineAiScienceSpark',
});
</script>
<template>
	<svg xmlns="http://www.w3.org/2000/svg" width="5rem" height="5rem" viewBox="0 0 14 14">
		<g fill="none" stroke="#15cce5" stroke-linecap="round" stroke-linejoin="round">
