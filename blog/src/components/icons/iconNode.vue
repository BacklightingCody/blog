...
<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="5em" height="5em" viewBox="0 0 512 314">
    <defs>
    ...
    <g fill="none">
      ...
      <g transform="translate(134.068 70.501)">
        ...
        <g mask="url(#logosNodejs8)">
          ...
          <path fill="url(#logosNodejs2)" fill-rule="evenodd" d="m50.391.809l-.693.347h.924z"
            transform="translate(0 -9.246)" />
          <path fill="url(#logosNodejs3)" fill-rule="evenodd"
            ...
            transform="translate(0 -9.246)" />
          <path fill="url(#logosNodejs4)" fill-rule="evenodd" d="m111.3 104.712l-.347-.578v.809z"
            transform="translate(0 -9.246)" />
          <path fill="url(#logosNodejs5)" fill-rule="evenodd"
            ...
            transform="translate(0 -9.246)" />
          <path fill="url(#logosNodejs6)" fill-rule="evenodd"
            d="m106.792 105.636l-48.773 28.085a7 7 0 0 1-2.196.693l.925 1.734l54.089-31.32v-.694l-1.387-2.312c-.231 1.618-1.271 3.005-2.658 3.814"
            transform="translate(0 -9.246)" />
        </g>
      </g>
